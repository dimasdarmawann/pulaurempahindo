...
@section('page-title', 'Edit Produk / Layanan')
@section('page-subtitle', 'Perbarui data produk atau layanan')
    ...
    <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="kategori" class="form-control" required>
                <option value="layanan" {{ old('kategori', $produk->kategori) === 'layanan' ? 'selected' : '' }}>Layanan</option>
                <option value="program" {{ old('kategori', $produk->kategori) === 'program' ? 'selected' : '' }}>Program</option>
            </select>
        ...
        <div class="form-group">
            ...
            @if($produk->gambar)
                <div>
                    ...
                    <img src="{{ asset('storage/' . $produk->gambar) }}" alt="Gambar" class="current-img">
                </div>
            @endif
